...
public class FileUploadController {
	...
	@GetMapping("/")
	public String gioithieu(Model model) throws IOException {
		return "gioithieu";
	}
	@GetMapping("webmau")
	public String webmau(Model model) throws IOException {
		return "webmau";
	}
	@GetMapping("tintuc-upload")
